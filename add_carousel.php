...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if (in_array($file_type, $allowed_types)) {
            ...
            $stmt = $conn->prepare("INSERT INTO carousel (image, caption) VALUES (?, ?)");
            $stmt->bind_param("bs", $null, $caption);
    ...
    <form method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <label class="file-upload" for="image-upload">
                ...
                <span class="file-info">(JPG, PNG, or GIF)</span>
        ...
        <button type="submit" class="btn btn-block">Add to Carousel</button>
    </form>
</div>
